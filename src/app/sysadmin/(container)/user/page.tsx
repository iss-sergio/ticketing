    ...
    <>
        <div className="card flex flex-col bg-white dark:bg-foreground dark:text-white overflow-hidden mb-24">
                ...
                <div className="py-4">
                        <div className="flex justify-between flex-wrap items-center">
                            ...
                            <div className=" text-gray-600">
                                <input
                                    className="bg-gray-100 dark:bg-foreground dark:text-white h-10 px-5 rounded-full text-sm focus:outline-none"
                                    type="search"
                                    name="search"
                                ...
                                <button
                                    role="button"
                                    className="absolute right-0 top-0 mt-2 focus:outline-none"
                                    type="submit"
                                />
                            </div>
                        </div>
            ...
            <div className="p-5">
                ...
                <div className="col-span-12 xl:col-span-3 lg:col-span-4">
                    <div className="card flex flex-col bg-white dark:bg-foreground dark:text-white">
                        <div  className="card-body">
                            <CardHeaderAction title="Create User" action="add" />
                            <div className="divide-y divide-gray-200 dark:divide-dark divide-solid">
                                <div className="flex items-center justify-between py-3 px-1">
                                    <span>All</span>
                                    <div className="bg-gray-100 dark:bg-gray-300 rounded-full flex items-center justify-center text-red-600 text-xs h-8 w-8 mr-2">
                                        99
                                    </div>
                                </div>
                                <div className="flex items-center justify-between py-3 px-1">
                ...
                <div className="col-span-12 xl:col-span-9 mb-4 lg:col-span-8">
                    <div className="card flex flex-col bg-white dark:bg-foreground dark:text-white">
                        <div  className="card-body">
                                            ...
                                            <tbody>
                                                {(() => {
                                                    ...
                                                    rows.push(
                                                        ...
                                                        <td> Juan Doe </td>
                                                        <td className="py-3"> email@sample.com </td>
