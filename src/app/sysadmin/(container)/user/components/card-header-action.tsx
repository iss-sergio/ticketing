...
const CardHeaderAction: React.FC<Props> = ({icon, title, action, status, role}) => {
    ...
    return (
        <>
            ...
            <Modal title="Create New User" isOpen={isModalOpenAdd} onClose={handleCloseModal} size="lg">
                    ...
                    <div className="block px-6 2xl:flex items-center justify-between mb-8 shadow-lg rounded-lg bg-white dark:bg-foreground dark:text-white">
                        <div className=" border-gray-100">
                            <dl className="divide-y divide-gray-100 text-wrap">
                                ...
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt className="text-xs font-medium leading-6 self-center text-gray-900">Email</dt>
                                    <dd className="mt-1 text-xs leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    <input type="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-xs  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="sample@email.com" required />
                                    </dd>
                                </div>
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <Modal title="User Information" isOpen={isModalOpenEdit} onClose={handleCloseModal} size="lg">
                <div className="w-full rounded-xl">
                    <div className="block px-6 2xl:flex items-center justify-between mb-8 shadow-lg rounded-lg bg-white dark:bg-foreground dark:text-white">
                        <div className=" border-gray-100">
                            <dl className="divide-y divide-gray-100 text-wrap">
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt className="text-xs font-medium leading-6 self-center text-gray-900">User ID</dt>
                                ...
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt className="text-xs font-medium leading-6 self-center text-gray-900">Email</dt>
                                    <dd className="mt-1 text-xs leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    <input type="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-xs  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="sample@email.com" required />
                                    </dd>
                                </div>
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt className="text-xs font-medium leading-6 self-center text-gray-900">Contact</dt>
            ...
            <Modal title="Delete User" isOpen={isModalOpenDelete} onClose={handleCloseModal} >
                
                <div className="mb-8 text-center">
                    <span className=" text-dark text-xl text-wrap">Are you sure want to delete this user?</span>
                </div>
