                ...
                <div className="col-span-12 xl:col-span-3 lg:col-span-4">
                    <div className="card flex flex-col bg-white dark:bg-foreground dark:text-white">
                        <div  className="card-body">
                            <CardHeaderAction title="Create Location" action="add" />
                            <div className="mt-4 divide-y divide-gray-200 dark:divide-dark divide-solid">
                                <div className="flex items-center justify-between py-3 px-1">
                                    <span>All</span>
                                    <div className="bg-gray-100 dark:bg-gray-300 rounded-full flex text-xs items-center justify-center text-red-600 font-medium h-8 w-8 mr-2">
                                        20
                                    </div>
                                </div>
                                <div className="flex items-center justify-between py-3 px-1">
                                ...
                                <tbody>
                                    {(() => {
                                        ...
                                        rows.push(
                                            ...
                                            <td> XX-AA001 </td>
                                            <td className="py-3"> Location {i+1} </td>
